...
return(
    <button type={type} onClick={onClick} className={`py-3 px-4 rounded-full outline-none w-full cursor-pointer my-5 mx-0 transition-all duration-300 ease-in ${style}`}>{children}</button>
)
}