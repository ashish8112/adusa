...
return(
    <section className="bg-surface border border-border rounded-xl text-text overflow-hidden ">
        ...
        <footer className="px-4 py-4 border-border border-t">
             <button  className={`flex items-center gap-2 transition-colors duration-200 ${post?.liked ? "text-like" : "text-muted hover:text-text"} cursor-pointer`}  onClick={toggleLike}>
